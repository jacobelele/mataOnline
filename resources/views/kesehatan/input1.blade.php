...
<div class="row">
  <div class="col-md-12 panel-info">
      <div class="panel-title "><center>Input Data Bidang Kesehatan</center></div>
          ...
          <div class="panel-body">
              ...
              <div class="form-group">
                  <form class="form-horizontal" role="form" method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tabel Kondisi Kesehatan Keluarga Tahun
                        </label>
...
<table id="example" class="table-bordered display scroll" style="width:100%">
        <thead>
            <tr>
                <th rowspan="3" colspan="2">Status Gizi</th>
                <th rowspan="2">RW 001</th>
                <th rowspan="2">RW 002</th>
                <th rowspan="2">RW 003</th>
                <th rowspan="2">RW 004</th>
        ...
        <tbody>
          <tr>
            <th rowspan="3">Bayi(0-12 Bulan)</th>
            <td>Baik</td>
          ...
          <td><input type="text" id="row-1-position" name="row-1-position"></td>
          <tr>
            <th rowspan="3">Bayi(1-4 Tahun)</th>
            <td>Baik</td>
            <td><input type="text" id="row-1-position" name="row-1-position"></td>
            <td><input type="text" id="row-1-position" name="row-1-position"></td>
            <td><input type="text" id="row-1-position" name="row-1-position"></td>
